      ...
      <DialogTitle sx={{ pb: 1 }}>
        <Box>
          ...
          <Typography variant="caption" color="textSecondary">
            Return received items back to vendor
          </Typography>
        </Box>
      </DialogTitle>
          ...
          <Grid container spacing={2}>
            ...
            <Grid item xs={12} sm={6} md={4}>
              <TextField
                ...
                placeholder="e.g. Defective batch received"
                size="small"
              />
            </Grid>
          </Grid>
            ...
            <TableContainer component={Paper} variant="outlined">
              {loadingItems ? (
                ...
                <Box sx={{ p: 4, textAlign: "center", color: "text.secondary" }}>
                  Select a PO to see received items
                </Box>
              ) : (
                <Table size="small">
                  ...
                  <TableBody>
                    {items.map((item, idx) => (
                      ...
                      >
                        ...
                        <TableCell align="right">{item.received_qty}</TableCell>
